...
<!--
<audio preload="auto" id="musique_defi" controls autoplay="autoplay">
	 <source src = "/webroot/sons/musique_defi.ogg" type="audio/ogg" />
     <source src = "/webroot/sons/musique_defi.mp3" type="audio/mp3" />
</audio>
-->
...
<div class="frame_without_background l100 h100">
  ...
  <!-- Bonnes et mauvaises réponses -->
    ...
    <!-- Score & challengeId -->
    <form id="form_challenge" action="/app/controllers/fin_defi.php" method="post">
...
<script src="/webroot/js/new_defi.js?nvd_r=xxx"></script>
