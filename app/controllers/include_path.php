...
$db_RO = new PDO('mysql:host=localhost;port=3306;dbname=navadra;charset=utf8', 'navadra', 'VOTRE_MOT_DE_PASSE');
$db_RO->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_WARNING);
$db_RW = new PDO('mysql:host=localhost;port=3306;dbname=navadra;charset=utf8', 'navadra', 'VOTRE_MOT_DE_PASSE');
